...
#
# This python code was modified for Bitcoin Core's RPC tests from ArtForz'
# public domain half-a-node, as found in the mini-node branch of
# http://github.com/jgarzik/pynode.
#
